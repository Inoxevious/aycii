...
class Articles(models.Model):
    ...
    blockquote1 =models.TextField(null=True ,blank=True)
    blockquote2 =models.TextField(null=True ,blank=True)
    blockquote1_owner =models.TextField(null=True ,blank=True)
    blockquote2_owner =models.TextField(null=True ,blank=True)
    isActive = models.BooleanField(default=True)
    isHomeArticle = models.BooleanField(default=True)
    written_date = models.DateTimeField()
    published_date = models.DateTimeField()
